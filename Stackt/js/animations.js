...
/* The veil-based "expand a coloured rectangle out of the tapped tile" transition
   was tried and removed: at this size it reads as a flat block sliding over the
   screen rather than an app opening, and it covered the menu's own zoom-out on
   the way back. Opening uses the directional slide; returning home is carried by
   the menu zooming out from centre, which is now actually visible. */
